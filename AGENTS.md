...
- Migration conventions & corrections: see `docs/migration-conventions.md` (DM images via `dm.js`, per-brand tokens, block CSS never sets `:root`, parser/SEO fixes, fragment `noindex`).
