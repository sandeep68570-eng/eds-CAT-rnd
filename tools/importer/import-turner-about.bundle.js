...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-turner-about.js
  var import_turner_about_exports = {};
  __export(import_turner_about_exports, {
    default: () => import_turner_about_default
  });
  ...
  // tools/importer/import-turner-about.js
  var parsers = { "page-hero": parse, timeline: parse2 };
  var PAGE_TEMPLATE = {
    name: "turner-about",
  ...
  var import_turner_about_default = {
    transform: (payload) => {
  ...
  return __toCommonJS(import_turner_about_exports);
})();
