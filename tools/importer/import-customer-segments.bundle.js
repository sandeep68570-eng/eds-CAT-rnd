...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-customer-segments.js
  var import_customer_segments_exports = {};
  __export(import_customer_segments_exports, {
    default: () => import_customer_segments_default
  });
  ...
  var import_customer_segments_default = {
    transform: (payload) => {
  ...
  return __toCommonJS(import_customer_segments_exports);
})();
