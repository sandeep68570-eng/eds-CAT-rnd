...
var CustomImportScript = (() => {
  ...
  var import_turner_knowledge_hub_exports = {};
  __export(import_turner_knowledge_hub_exports, {
    default: () => import_turner_knowledge_hub_default
  });
  ...
  var import_turner_knowledge_hub_default = {
    transform: (payload) => {
  ...
  return __toCommonJS(import_turner_knowledge_hub_exports);
})();
